...
Section WithMap.
  ...
  Proof.
    ...
    simpl. repeat (case_match; auto).
    repeat invert_type_of_clear.
    repeat (econstructor ; eauto with conquord_hints).
  ...
  Proof.
    ...
    rewrite Forall_forall; intros.
    apply_Forall_In.
    apply_type_sound e2_1; eauto with conquord_hints. invert_type_of_value_clear.
...
Section WithMap.
  ...
  Proof.
    ...
    rewrite <- not_free_immut_put_sem with (e:=e3_1); auto.
    rewrite_expr_value; cbn.
    apply_type_sound e3_2; eauto with conquord_hints.
